setInterval(function () {
    ...
    columns.forEach(function (column) {
        ...
        cards.forEach(function (card) {
            ...
            while (i < 20 && matchResult !== null) {
                if (matchResult.length === 5) {
                    let typeContent;
                    let matchIndex;
                    // we expect five result items:
                    // 0: full string match, 1: surrounding parenthesis,  2: left parentheses for '(...)' matches, 3: right parentheses for '[...]' matches, 4: right parentheses for '{}...}' matches
        ...
        column.querySelectorAll('div.extraRow span.label-success').forEach(function (it) {
                let value = it.getAttribute('data-value');
                if (value) {
        ...
        sumColumnInvestedEstimate = Math.round(sumColumnInvestedEstimate * 100) / 100;
